use crate::ast::{
    ...
    ImportedModuleName, IngestedFileImport, ModuleImport, ModuleImportParams, Pattern,
...
fn import_body<'a>() -> impl Parser<'a, ValueDef<'a>, EImport<'a>> {
    map!(
        record!(ModuleImport {
            ...
            params: optional(backtrackable(specialize_err(
                EImport::Params,
                import_params()
            ))),
